// Taken from https://github.com/serenize/snaker
// !! EXCEPT that this uses dash instead of underscore!!
// Package snaker provides methods to convert CamelCase names to snake-case and back.
