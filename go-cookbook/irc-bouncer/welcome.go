...
func (c *Client) Welcome() {
	c.SendServerMessage("001", "danopia", "Welcome to the "+c.homeDomain+" Internet Relay Chat Headend danopia")
	c.SendServerMessage("002", "danopia", "Your host is "+c.serverName+"["+c.serverName+"/6667], running bounce.go")
	c.SendServerMessage("003", "danopia", "This server was created Wed Feb 17 22:23:45 UTC 2016")
	c.SendServerMessage("004", "danopia", c.serverName, "stardust-irc-0.0.1", "DQRSZagiloswz", "CFILPQbcefgijklmnopqrstvz", "bkloveqjfI")
	...
	c.SendServerMessage("375", "danopia", "- "+c.serverName+" Message of the Day -")
