const {ReactiveVar} = Package['reactive-var'];
const {ReactiveArray} = Package['manuel:reactivearray'];
const {Tracker} = Package.tracker;
const {Blaze} = Package.ui;
const {SpacebarsCompiler} = Package['spacebars-compiler'];
const {UI} = Package.ui;
const {Router} = Package['iron:router'];
const {Template} = Package['templating-runtime'];
const {Astro} = Package['jagi:astronomy'];
const {Mongo} = Package.mongo;
const {Session} = Package.session;
const {HTML} = Package.htmljs;
const {Spacebars} = Package.spacebars;
const {Meteor} = Package.meteor;
const {moment} = Package['momentjs:moment'];
const {check} = Package.check;
const {Random} = Package.random;
